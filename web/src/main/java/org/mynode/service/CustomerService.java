...
//    public boolean updateCustomer(Customer customer){return customerDao.updateCustomer(customer); }
    public Customer getCustomerByCredentials(String emailOrName, String password) throws Exception {
        return customerDao.getCustomerByCredentials(emailOrName, password);
    }
}
